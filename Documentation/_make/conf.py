# -*- coding: utf-8 -*-
#
# Powermail CSS documentation build configuration file, created by
# TYPO3 extension sphinx on Sat, 17 Oct 2015 22:42:14 +0200.
#
...
project = u'Powermail CSS'
copyright = u'2015, r3h6'
...
htmlhelp_basename = 'powermail_cssdoc'
...
latex_documents = [
    ('Index', 'powermail_css.tex', u'Powermail CSS',
     u'r3h6', 'manual'),
]
...
pdf_documents = [
    ('Index', 'powermail_css', u'Powermail CSS',
     u'r3h6'),
]
...
texinfo_documents = [
    ('Index', 'powermail_css', u'Powermail CSS',
     u'r3h6', 'Powermail CSS', 'One line description of project.',
     'Miscellaneous'),
]
